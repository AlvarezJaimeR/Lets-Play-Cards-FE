			...
			<div className="home font-link row">
				...
				<div className="col-12 col-xs-12 col-sm-12 col-lg-6 d-flex">
					<div className="col-lg-12 col-sm-12 col-xs-12 homepage-sections first border rounded flex-fill">
						<h1 className="bg-dark rounded px-4 text-light">
						...
						<div className="rules-container rounded border text-left">
							<div className="trans-content">
								...
								<ul>
									...
									<li>
										If the card is the same value... each player will turn up
										the next card. If the turned-up cards are the same value
										again then each player will again turn up the next card. The
										player with the higher card value wins that round and
										receives a bonus score for each previous tie.{" "}
									</li>
									<li>
										The game ends after 26 rounds have been played. The winner
										of the game is the player who wins the most rounds and
